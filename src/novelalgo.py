...
jobs = { 0 : [
        ...
        Job(2, 3, 2, 0, job_error_func, lambda x, y, z : z, job_comparison_func),
        Job(3, 4, 2, 0, job_error_func, lambda x, y, z : z, job_comparison_func),
        Job(4, 5, 2, 0, job_error_func, lambda x, y, z : z, job_comparison_func),
        Job(5, 6, 2, 0, job_error_func, lambda x, y, z : z, job_comparison_func),
